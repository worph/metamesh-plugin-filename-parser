 ...
 *
 * This plugin (filename-parser) only requires mount 2:
 *   - /cache (RW) - to cache parsed filename results
 *   - Note: This plugin parses filenames from metadata, doesn't read files
 *
